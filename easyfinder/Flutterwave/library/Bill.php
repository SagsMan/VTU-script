...
class Bill
{
    ...
    function __construct()
    {
        ...
        $this->type = array('AIRTIME', 'DSTV', 'DSTV BOX OFFICE', 'Postpaid', 'Prepaid', 'AIRTEL', 'IKEDC TOP UP', 'EKEDC POSTPAID TOPUP', 'EKEDC PREPAID TOPUP', 'LCC', 'KADUNA TOP UP','MTN 200 MB DATA BUNDLE');
    }
    ...
    function payBill($array)
    {
        ...
        case 'MTN 200 MB DATA BUNDLE':
                //set type to dstv box office
                $this->type = 'MTN 200 MB DATA BUNDLE';
...
function getBillersProducts($array)
    {

    $this->payment->eventHandler(new billEventHandler);
        if (array_key_exists('product_id', $array)) {
            $this->payment->setEndPoint('v3/billers/'.$array['product_id'].'/products');
        }
