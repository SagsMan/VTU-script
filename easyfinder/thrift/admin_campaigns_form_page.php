...
/**************************************************************/
//VERSION:  
//COMPONENT:admin_campaigns_form_component
//TITLE:    Campaigns
//TYPE:     formV5
...
$admin_campaigns_form_component_multipartComponentToDisplayName="";//this is needed to determine which multipart active component to display

//ini with page level values if enabled$admin_campaigns_form_component_errorMessage= $errorMessage;
  ...
  case "save":
    /*Will only execute for a submitted component, and else for the other components$app->pages[$ipages]->components[$icomponent]->title*/
        ...
        if($admin_campaigns_form_component_submittedComponentTitle==="admin_campaigns_form_component")
        {
          if($admin_campaigns_form_component_id < 1){
            /*if theres a file to upload then try uploading*/  
                ...
                if (isset($_FILES["admin_campaigns_form_component_poster"]) && !empty($_FILES["admin_campaigns_form_component_poster"])  && !empty($_FILES["admin_campaigns_form_component_poster"]["name"]) ){
                  ...
                  /*get extension*/
                  /*$fileType = $_FILES["poster"]["type"];*/$fileName = $_SESSION[APP_SESSION_NAME]["id"]."-poster-".$_FILES["admin_campaigns_form_component_poster"]["name"];
                    ...
                    /*rename
                    $fileName = $_SESSION[APP_SESSION_NAME]["id"]."-o-".$admin_campaigns_form_component_poster.".".$fileType;
                    echo $fileName;exit();*/
                    ...
                    if (!empty($filePath)) {
                      $admin_campaigns_form_component_poster=$fileName;/*$filePath.$fileName;*/
          ...
          }elseif ($admin_campaigns_form_component_id > 0 ) 
          {try 
            {
              /*if theres a file to upload then try uploading*/  
                /*handle doc*/
...
<form  class="23-o--link--o-802-o--link--o-admin_campaigns_form_page.php-o--link--o-980-o--link--o-admin_campaigns_form_component-o--link--o-form"  id= "23-o--link--o-Thrift-o--link--o-802-o--link--o-admin_campaigns_form_page-o--link--o-980-o--link--o-admin_campaigns_form_component-o--link--o-form" method="POST" action=""  enctype="multipart/form-data">
              ...
              <div class="rowx"><div class=" p-1 mb-2"><div class ="row"><div class="col-12 mb-0 pb-0"><p class="mb-0 pb-0 pl-2 font-weight-bold"></p></div><div class="col-12 col-md-4">
                    ...
                    <div class="form-group"><label class="col-sm-12 col-form-label pb-0 mb-0 font-weight-bold"><?php echo(putSpaceBetweenWords("Poster"));?></label><div class="col-12"><input type="file"  class="form-control form-control-sm" name="admin_campaigns_form_component_poster"  id="23-o--link--o-Thrift-o--link--o-802-o--link--o-admin_campaigns_form_page-o--link--o-980-o--link--o-admin_campaigns_form_component-o--link--o-poster"  idx="admin_campaigns_form_page-o--link--o-admin_campaigns_form_component-o--link--o-poster" value="<?php echo $admin_campaigns_form_component_poster;?>"  ><small class="font-weight-bold"><a target="_blank" href="<?php echo APP_UPLOADS.APP_DOCUMENTS;?><?php echo $admin_campaigns_form_component_poster;?>"><?php echo $admin_campaigns_form_component_poster;?>
                      ...
                      <input type="hidden" name="admin_campaigns_form_component_poster-currentname" id="poster-currentname" value="<?php echo $admin_campaigns_form_component_poster;?>" ><div class="col-12 ml-0 pl-0"><small class="help font-weight-bold text-danger ml-0"></small></div>
                           </div></div>
                      </div>
<div class="col-12 col-md-12 col-lg-12">

                    <div class="form-group"><label class="col-sm-12 col-form-label pb-0 mb-0 font-weight-bold"><?php echo(putSpaceBetweenWords("Donation_title"));?></label><div class="col-12"><input type="text"  class="form-control form-control-sm" name="admin_campaigns_form_component_donation_title"  id="23-o--link--o-Thrift-o--link--o-802-o--link--o-admin_campaigns_form_page-o--link--o-980-o--link--o-admin_campaigns_form_component-o--link--o-donation_title"  idx="admin_campaigns_form_page-o--link--o-admin_campaigns_form_component-o--link--o-donation_title" value="<?php echo $admin_campaigns_form_component_donation_title;?>"  ><div class="col-12 ml-0 pl-0"><small class="help font-weight-bold text-danger ml-0"></small></div>
                           </div></div>
                      </div>
<div class="col-12 col-md-12 col-lg-12">

                    <div class="form-group"><label class="col-sm-12 col-form-label pb-0 mb-0 font-weight-bold"><?php echo(putSpaceBetweenWords("Video_url"));?></label><div class="col-12"><input type="text"  class="form-control form-control-sm" name="admin_campaigns_form_component_video_url"  id="23-o--link--o-Thrift-o--link--o-802-o--link--o-admin_campaigns_form_page-o--link--o-980-o--link--o-admin_campaigns_form_component-o--link--o-video_url"  idx="admin_campaigns_form_page-o--link--o-admin_campaigns_form_component-o--link--o-video_url" value="<?php echo $admin_campaigns_form_component_video_url;?>"  ><div class="col-12 ml-0 pl-0"><small class="help font-weight-bold text-danger ml-0"></small></div>
                           </div></div>
                      </div>
<div class="col-12 col-md-3 col-lg-3">

                    <div class="form-group"><label class="col-sm-12 col-form-label pb-0 mb-0 font-weight-bold"><?php echo(putSpaceBetweenWords("Category"));?></label><div class="col-12"><input type="text"  class="form-control form-control-sm" name="admin_campaigns_form_component_category"  id="23-o--link--o-Thrift-o--link--o-802-o--link--o-admin_campaigns_form_page-o--link--o-980-o--link--o-admin_campaigns_form_component-o--link--o-category"  idx="admin_campaigns_form_page-o--link--o-admin_campaigns_form_component-o--link--o-category" value="<?php echo $admin_campaigns_form_component_category;?>"  ><div class="col-12 ml-0 pl-0"><small class="help font-weight-bold text-danger ml-0"></small></div>
                           </div></div>
                      </div>
<div class="col-12 col-md-4">

                    <div class="form-group"><label class="col-sm-12 col-form-label pb-0 mb-0 font-weight-bold"><?php echo(putSpaceBetweenWords("Donate_goal"));?></label><div class="col-12"><input type="decimal"  class="form-control form-control-sm" name="admin_campaigns_form_component_donate_goal"  id="23-o--link--o-Thrift-o--link--o-802-o--link--o-admin_campaigns_form_page-o--link--o-980-o--link--o-admin_campaigns_form_component-o--link--o-donate_goal"  idx="admin_campaigns_form_page-o--link--o-admin_campaigns_form_component-o--link--o-donate_goal" value="<?php echo $admin_campaigns_form_component_donate_goal;?>"  ><div class="col-12 ml-0 pl-0"><small class="help font-weight-bold text-danger ml-0"></small></div>
                           </div></div>
                      </div>
<div class="col-12 col-md-4">

                    <div class="form-group"><label class="col-sm-12 col-form-label pb-0 mb-0 font-weight-bold"><?php echo(putSpaceBetweenWords("Current_amount_raised"));?></label><div class="col-12"><input type="decimal"  class="form-control form-control-sm" name="admin_campaigns_form_component_current_amount_raised"  id="23-o--link--o-Thrift-o--link--o-802-o--link--o-admin_campaigns_form_page-o--link--o-980-o--link--o-admin_campaigns_form_component-o--link--o-current_amount_raised"  idx="admin_campaigns_form_page-o--link--o-admin_campaigns_form_component-o--link--o-current_amount_raised" value="<?php echo $admin_campaigns_form_component_current_amount_raised;?>"  ><div class="col-12 ml-0 pl-0"><small class="help font-weight-bold text-danger ml-0"></small></div>
                           </div></div>
                      </div>
<div class="col-12 col-md-12 col-lg-12">

                    <div class="form-group"><label class="col-sm-12 col-form-label pb-0 mb-0 font-weight-bold"><?php echo(putSpaceBetweenWords("Location"));?></label><div class="col-12"><input type="text"  class="form-control form-control-sm" name="admin_campaigns_form_component_location"  id="23-o--link--o-Thrift-o--link--o-802-o--link--o-admin_campaigns_form_page-o--link--o-980-o--link--o-admin_campaigns_form_component-o--link--o-location"  idx="admin_campaigns_form_page-o--link--o-admin_campaigns_form_component-o--link--o-location" value="<?php echo $admin_campaigns_form_component_location;?>"  ><div class="col-12 ml-0 pl-0"><small class="help font-weight-bold text-danger ml-0"></small></div>
                           </div></div>
                      </div>
<div class="col-12 col-md-4">

                    <div class="form-group"><label class="col-sm-12 col-form-label pb-0 mb-0 font-weight-bold"><?php echo(putSpaceBetweenWords("About_the_donation"));?></label><div class="col-12"><textarea  class="form-control form-control-sm" name="admin_campaigns_form_component_about_the_donation"  id="23-o--link--o-Thrift-o--link--o-802-o--link--o-admin_campaigns_form_page-o--link--o-980-o--link--o-admin_campaigns_form_component-o--link--o-about_the_donation"  idx="admin_campaigns_form_page-o--link--o-admin_campaigns_form_component-o--link--o-about_the_donation"  ><?php echo $admin_campaigns_form_component_about_the_donation;?></textarea><div class="col-12 ml-0 pl-0"><small class="help font-weight-bold text-danger ml-0"></small></div>
                           </div></div>
                      </div>
<div class="col-12 col-md-4">
              ...
              <input  type="checkbox" class="form-controlx form-control-smx form-check-input" name="admin_campaigns_form_component_isActive"  id="23-o--link--o-Thrift-o--link--o-802-o--link--o-admin_campaigns_form_page-o--link--o-980-o--link--o-admin_campaigns_form_component-o--link--o-isActive"  idx="admin_campaigns_form_page-o--link--o-admin_campaigns_form_component-o--link--o-isActive" value="1"                       
              <?php if ($admin_campaigns_form_component_isActive==1) {?>
                   checked 
                <?php }?>
        ...
        <div class="col-12 mt-2">
          <div class="col-sm-12 text-center">  <a class="btn btn-sm btn-dark" href="admin_campaigns_list_page.php?searchTerm=<?php echo ($searchTerm);?>" id="admin_campaigns_form_component_closebutton"   >Close</a>
<!--p class="card-title">Campaigns</p-->
<?php /*if (strpos($_SESSION[APP_SESSION_NAME]["privileges"], Privilege_AddUsers_Enabled) !== FALSE) {*/ ?>

<a class="btn btn-sm btn-primary btn-lg text-white" href="admin_campaigns_form_page.php?admin_campaigns_form_component_id=-1&admin_campaigns_form_component_task=new&id=<?php echo $id;?>&id=<?php echo $task;?>&searchTerm=<?php echo $searchTerm;?>"  id="admin_campaigns_form_component_newbutton" >
Add New </a><!-- Campaigns</a-->
  <button type="submit" class="btn btn-sm btn-primary mr-2" name="admin_campaigns_form_component_doSubmit" value="admin_campaigns_form_component"  id="admin_campaigns_form_component_savebutton" >Save</button></div>
        </div>
      </div>
