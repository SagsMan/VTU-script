...
$PAGE_TITLE   = 'IPE Clearing';
$URL_NAME     = 'IPE Clearing';
            ...
            <div class="container-fluid">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <span class="badge badge-danger p-1"> ₦ <?= IPE_CLEARING_PRICE ?></span>
                                        </div>
                                    </div>
                                </div>
                            </button>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            if ($ninPersonalizations = $AdminTask->Get_All_NIN_Validations($Auth->email, 'ipe_clearing')) {
                                                ...
                                                foreach ($ninPersonalizations as $ninPersonalization) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>₦ <?php echo $ninPersonalization->price ?? '0' ?></td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown ml-auto text-right">
                                                                ...
                                                                ?>
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" data-toggle="modal" data-target="#modal-default_<?= $ninPersonalization->id ?>">View Validation Info</a>
                                                                    </div>
                                                                <?php
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">View: <?= ucwords(str_replace('_', ' ', $ninPersonalization->type)) ?> Validation Request</h4>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>NIN:</label>
                                                                        <input class="form-control" type="text" value="<?= $ninPersonalization->nin ?>" readonly>
                                                                    </div>
                ...
                <div class="modal fade" id="ICModal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">IPE clearing > IPE clearing</h5>
                                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="basic-form">
                                    <form id="ipe-clearing-form">
                                        <div class="form-row">
                                        ...
                                        <button type="submit" class="btn btn-success w-100">
                                            ...
                                            Verify <span class="badge badge-danger p-1">₦ <?= IPE_CLEARING_PRICE ?></span>
                                        </button>
